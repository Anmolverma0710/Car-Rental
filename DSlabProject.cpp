...
user *createuser(user*last)
{
    ...
    last=create_user(last,"Anmol","12345");
    last=create_user(last,"Rohit","35467");
    last=create_user(last,"Harshit","H1234");
    last=create_user(last,"Vivek","V134w5");
...
car* createcar(car *root)
{
    ...
    root=create_car(root,6,4400,7,"Creata");
    return root;
}
...
int k=3*x;
          ...
          cout<<setw(24+k)<<"/           \\ "<<endl;
         cout<<setw(24+k)<<"/             \\"<<endl;
 cout<<setw(33+k)<<"_______/               \\_______ "<<endl;
...
//the funcanality of user and owmer
...
int main()
{
    PlaySound(TEXT("C:\\Users\\Madhura Jituri\\Downloads\\Amplifier"),NULL,SND_ASYNC);
    sleep(3.5);
    welcome();
    car *root=NULL;
    user *last=NULL;
